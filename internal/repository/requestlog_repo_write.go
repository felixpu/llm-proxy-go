...
func (r *RequestLogRepositoryImpl) Insert(ctx context.Context, entry *models.RequestLogEntry) (int64, error) {
	...
	result, err := r.db.ExecContext(ctx,
		`INSERT INTO request_logs (
			request_id, user_id, api_key_id, model_name, requested_model, resolved_model, endpoint_name,
		...
		entry.RequestID, entry.UserID, entry.APIKeyID, entry.ModelName, entry.RequestedModel, entry.ResolvedModel, entry.EndpointName,
