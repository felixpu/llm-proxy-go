...
(function () {
  ...
  /**
   * Format compact JSON string with pretty-print indentation.
   * JSON.parse automatically decodes Unicode escapes like \u003e.
   * @param {string} str - Raw JSON string
   * @returns {string} Formatted JSON or original string if not valid JSON
   */
  ...
  /**
   * Add syntax highlighting spans to a pre-formatted JSON string.
   * Input must be plain text (not HTML). Output is safe HTML.
