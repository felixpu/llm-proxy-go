        ...
        <div class="modal-content modal-lg" @click.stop>\
            ...
            <div class="modal-body" v-show="!detailLoading">\
                <div v-if="logDetail" class="log-detail-content">\
                    ...
                    <!-- 消息查看器 -->\
                    <div class="detail-section" v-show="logDetail.request_content || logDetail.response_content">\
                        <message-viewer\
                          :request-content="logDetail.request_content || \'\'"\
                          :response-content="logDetail.response_content || \'\'"\
                          :success="logDetail.success">\
                        </message-viewer>\
                    </div>\
                </div>\
            </div>\
