...
func initRepositories(db, readDB *sql.DB, logger *zap.Logger) appRepositories {
	...
	return appRepositories{
		...
		logWriteRepo:       repository.NewRequestLogWriteRepository(logRepoImpl),
		logQueryRepo:       repository.NewRequestLogQueryRepository(logRepoImpl),
		logAnalyticsRepo:   repository.NewRequestLogAnalyticsRepository(logRepoImpl),
